...
use sha2::Digest;
use stacks_common::{debug, trace, test_debug};
use stacks_common::types::chainstate::{
    TrieHash, TRIEHASH_ENCODED_SIZE,
};
use stacks_common::util::macros::is_trace;

use crate::bits::{
    get_leaf_hash, get_node_hash,
};
use crate::db::TrieDb;
use crate::marf::MARF;
use crate::node::{
...
use crate::{
    Result, MarfTrieId, TrieHashExtension, TrieHasher, TrieLeaf, MarfError,
};
...
fn get_nodetype_hash<Id, TrieDB>(
...
impl Trie {
    ...
    fn read_root_maybe_hash<Id, TrieDB>(
        storage: &mut TrieStorageConnection<Id, TrieDB>,
        read_hash: bool,
    ) -> Result<(TrieNodeType, Option<TrieHash>)> 
    where
        Id: MarfTrieId,
        TrieDB: TrieDb
    {
    ...
    pub fn read_root_nohash<Id, TrieDB>(
        storage: &mut TrieStorageConnection<Id, TrieDB>,
    ) -> Result<TrieNodeType> 
    where
        Id: MarfTrieId,
    ...
    fn walk_from_maybe_hash<Id, TrieDB>(
        storage: &mut TrieStorageConnection<Id, TrieDB>,
        node: &TrieNodeType,
        cursor: &mut TrieCursor<Id>,
        read_hash: bool,
    ) -> Result<Option<(TriePtr, TrieNodeType, TrieHash)>> 
    where
        Id: MarfTrieId,
        TrieDB: TrieDb
    {
    ...
    pub fn walk_from_nohash<Id, TrieDB>(
        storage: &mut TrieStorageConnection<Id, TrieDB>,
        node: &TrieNodeType,
        cursor: &mut TrieCursor<Id>,
    ) -> Result<Option<(TriePtr, TrieNodeType)>> 
    where
        Id: MarfTrieId,
        TrieDB: TrieDb
    {
    ...
    pub fn walk_backptr<Id, TrieDB>(
        storage: &mut TrieStorageConnection<Id, TrieDB>,
        ptr: &TriePtr,
        cursor: &mut TrieCursor<Id>,
    ) -> Result<(TrieNodeType, TrieHash, TriePtr)> 
    where
        Id: MarfTrieId,
        TrieDB: TrieDb
    {
    ...
    pub fn get_children_hashes<Id, TrieDB>(
        storage: &mut TrieStorageConnection<Id, TrieDB>,
        node: &TrieNodeType,
    ) -> Result<Vec<TrieHash>> 
    where
    ...
    ///
    fn promote_leaf_to_node4<Id, TrieDB>(
        storage: &mut TrieStorageConnection<Id, TrieDB>,
        cursor: &mut TrieCursor<Id>,
    ...
    #[cfg(test)]
    pub fn test_promote_leaf_to_node4<Id, TrieDB>(
        storage: &mut TrieStorageConnection<Id, TrieDB>,
        cursor: &mut TrieCursor<Id>,
        cur_leaf_data: &mut TrieLeaf,
        new_leaf_data: &mut TrieLeaf,
    ...
    #[cfg(test)]
    pub fn test_try_attach_leaf<Id, TrieDB>(
        storage: &mut TrieStorageConnection<Id, TrieDB>,
        cursor: &mut TrieCursor<Id>,
        leaf: &mut TrieLeaf,
        node: &mut TrieNodeType,
    ...
    #[cfg(test)]
    pub fn test_insert_leaf<Id, TrieDB>(
        storage: &mut TrieStorageConnection<Id, TrieDB>,
        cursor: &mut TrieCursor<Id>,
        leaf: &mut TrieLeaf,
        node: &mut TrieNodeType,
    ...
    #[cfg(test)]
    pub fn test_splice_leaf<Id, TrieDB>(
        storage: &mut TrieStorageConnection<Id, TrieDB>,
        cursor: &mut TrieCursor<Id>,
        leaf: &mut TrieLeaf,
        node: &mut TrieNodeType,
    ...
    fn inner_get_trie_ancestor_hashes_bytes<Id, TrieDB>(
        storage: &mut TrieStorageConnection<Id, TrieDB>,
    ) -> Result<Vec<TrieHash>> 
    where
        Id: MarfTrieId,
    ...
    pub fn get_trie_ancestor_hashes_bytes<Id, TrieDB>(
        storage: &mut TrieStorageConnection<Id, TrieDB>,
    ) -> Result<Vec<TrieHash>> 
    where
        Id: MarfTrieId,
    ...
    pub fn get_trie_root_ancestor_hashes_bytes<Id, TrieDB>(
        storage: &mut TrieStorageConnection<Id, TrieDB>,
    ...
    /// as we can go.
    pub fn get_trie_root_hash<Id, TrieDB>(
        storage: &mut TrieStorageConnection<Id, TrieDB>,
        children_root_hash: &TrieHash,
    ) -> Result<TrieHash> 
    where
    ...
    fn recalculate_root_hash<Id, TrieDB>(
        storage: &mut TrieStorageConnection<Id, TrieDB>,
        cursor: &TrieCursor<Id>,
    ...
    pub fn update_root_hash<Id, TrieDB>(
        storage: &mut TrieStorageConnection<Id, TrieDB>,
        cursor: &TrieCursor<Id>,
    ) -> Result<()> 
    where
    ...
    pub fn update_root_node_hash<Id, TrieDB>(
        storage: &mut TrieStorageConnection<Id, TrieDB>,
        cursor: &TrieCursor<Id>,
    ) -> Result<()> 
    where
