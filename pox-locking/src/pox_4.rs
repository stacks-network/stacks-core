...
///   account which isn't locked. This *should* have been checked by the PoX v4
...
/// Handle responses from stack-stx and delegate-stack-stx in pox-4 -- functions
/// that *lock up* STX
...
/// Handle responses from stack-extend and delegate-stack-extend in pox-4 --
...
/// Handle responses from stack-increase and delegate-stack-increase in PoX-4 --
