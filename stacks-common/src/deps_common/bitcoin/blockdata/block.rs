...
impl BlockHeader {
    ...
    /// Performs an SPV validation of a block, which confirms that the
    /// proof-of-work is correct, but does not verify that the transactions
    /// are valid or encoded correctly.
    ...
    pub fn work(&self) -> Uint256 {
        // 2**256 / (target + 1) == ~target / (target+1) + 1    (eqn shamelessly stolen
        // from bitcoind)
...
mod tests {
    ...
    // Check testnet block
    // 000000000000045e0b1660b6445b5e5c5ab63c9a4f956be7e1e69be04fa4497b
    #[test]
