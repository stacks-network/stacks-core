...
def scenario( wallets, **kw ):
    ...
    testlib.blockstack_name_preorder( "foo_fail.test1", wallets[1].privkey, wallets[3].addr, price={'units': 'STACKS', 'amount': stacks_price}, burn_addr=wallets[0].addr, safety_checks=False, expect_fail=True)
    testlib.blockstack_name_preorder( "bar_fail.test1", wallets[1].privkey, wallets[3].addr, burn_addr=wallets[0].addr, safety_checks=False, expect_fail=True)
    testlib.blockstack_name_preorder( "foo_fail.test2", wallets[1].privkey, wallets[3].addr, burn_addr=wallets[1].addr, safety_checks=False, expect_fail=True)
    testlib.blockstack_name_preorder( "foo_fail.test3", wallets[1].privkey, wallets[3].addr, burn_addr=wallets[0].addr, safety_checks=False, expect_fail=True)
    testlib.next_block(**kw)

    # should all fail--not preordered
    testlib.blockstack_name_register( "foo_fail.test1", wallets[1].privkey, wallets[3].addr ) # paid in Stacks
    testlib.blockstack_name_register( "bar_fail.test1", wallets[1].privkey, wallets[3].addr ) # paid in BTC
    testlib.blockstack_name_register( "foo_fail.test2", wallets[1].privkey, wallets[3].addr ) # paid in BTC to wallets[0]
    testlib.blockstack_name_register( "foo_fail.test3", wallets[1].privkey, wallets[3].addr ) # paid in Stacks
    testlib.next_block(**kw)
