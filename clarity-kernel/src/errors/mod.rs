...
impl From<crate::costs::CostFunctionError> for VmExecutionError {
    fn from(err: crate::costs::CostFunctionError) -> Self {
        use crate::costs::CostFunctionError;
...
mod test {
    ...
    use crate::errors::{EarlyReturnError, VmExecutionError, VmInternalError};
