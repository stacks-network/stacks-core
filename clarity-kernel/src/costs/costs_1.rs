...
impl CostValues for Costs1 {
    ...
    fn cost_analysis_visit(_n: u64) -> Result<ExecutionCost, CostFunctionError> {
    ...
    fn cost_analysis_option_cons(_n: u64) -> Result<ExecutionCost, CostFunctionError> {
        Ok(ExecutionCost::runtime(1000))
    }

    fn cost_analysis_option_check(_n: u64) -> Result<ExecutionCost, CostFunctionError> {
        Ok(ExecutionCost::runtime(1000))
    }
    ...
    fn cost_analysis_lookup_function(_n: u64) -> Result<ExecutionCost, CostFunctionError> {
        Ok(ExecutionCost::runtime(1000))
    }
    ...
    fn cost_analysis_lookup_variable_const(_n: u64) -> Result<ExecutionCost, CostFunctionError> {
        Ok(ExecutionCost::runtime(1000))
    }
    ...
    fn cost_lookup_function(_n: u64) -> Result<ExecutionCost, CostFunctionError> {
        Ok(ExecutionCost::runtime(1000))
    }

    fn cost_bind_name(_n: u64) -> Result<ExecutionCost, CostFunctionError> {
        Ok(ExecutionCost::runtime(1000))
    }
    ...
    fn cost_buff_to_int_le(n: u64) -> Result<ExecutionCost, CostFunctionError> {
        Err(CostFunctionError::NotImplemented)
    }
    ...
    fn cost_verify_merkle_proof(_n: u64) -> Result<ExecutionCost, CostFunctionError> {
        Err(CostFunctionError::NotImplemented)
    }

    fn cost_get_bitcoin_tx_output(_n: u64) -> Result<ExecutionCost, CostFunctionError> {
        Err(CostFunctionError::NotImplemented)
    }
