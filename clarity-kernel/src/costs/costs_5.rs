...
impl CostValues for Costs5 {
    ...
    fn cost_len(_n: u64) -> Result<ExecutionCost, CostFunctionError> {
        Ok(ExecutionCost::runtime(31))
    }
    // Bench: element-at/* → 31 units constant; n=args.len()=2 always at runtime.
    fn cost_element_at(_n: u64) -> Result<ExecutionCost, CostFunctionError> {
        Ok(ExecutionCost::runtime(31))
    }
    ...
    fn cost_int_cast(_n: u64) -> Result<ExecutionCost, CostFunctionError> {
        Ok(ExecutionCost::runtime(31))
    }
    fn cost_mod(_n: u64) -> Result<ExecutionCost, CostFunctionError> {
        Ok(ExecutionCost::runtime(31))
    }
    fn cost_pow(_n: u64) -> Result<ExecutionCost, CostFunctionError> {
        Ok(ExecutionCost::runtime(31))
    }
    fn cost_sqrti(_n: u64) -> Result<ExecutionCost, CostFunctionError> {
        Ok(ExecutionCost::runtime(31))
    }
    fn cost_log2(_n: u64) -> Result<ExecutionCost, CostFunctionError> {
        Ok(ExecutionCost::runtime(31))
    }
    ...
    fn cost_not(_n: u64) -> Result<ExecutionCost, CostFunctionError> {
        Ok(ExecutionCost::runtime(31))
    }
    ...
    fn cost_secp256k1recover(_n: u64) -> Result<ExecutionCost, CostFunctionError> {
    ...
    fn cost_secp256k1verify(_n: u64) -> Result<ExecutionCost, CostFunctionError> {
        Ok(ExecutionCost::runtime(38))
    }
    ...
    fn cost_some_cons(_n: u64) -> Result<ExecutionCost, CostFunctionError> {
        Ok(ExecutionCost::runtime(31))
    }
    fn cost_ok_cons(_n: u64) -> Result<ExecutionCost, CostFunctionError> {
        Ok(ExecutionCost::runtime(31))
    }
    fn cost_err_cons(_n: u64) -> Result<ExecutionCost, CostFunctionError> {
        Ok(ExecutionCost::runtime(31))
    }
    fn cost_default_to(_n: u64) -> Result<ExecutionCost, CostFunctionError> {
        Ok(ExecutionCost::runtime(31))
    }
    fn cost_unwrap_ret(_n: u64) -> Result<ExecutionCost, CostFunctionError> {
        Ok(ExecutionCost::runtime(31))
    }
    fn cost_unwrap_err_or_ret(_n: u64) -> Result<ExecutionCost, CostFunctionError> {
        Ok(ExecutionCost::runtime(31))
    }
    fn cost_is_okay(_n: u64) -> Result<ExecutionCost, CostFunctionError> {
        Ok(ExecutionCost::runtime(31))
    }
    fn cost_is_none(_n: u64) -> Result<ExecutionCost, CostFunctionError> {
        Ok(ExecutionCost::runtime(31))
    }
    fn cost_is_err(_n: u64) -> Result<ExecutionCost, CostFunctionError> {
        Ok(ExecutionCost::runtime(31))
    }
    fn cost_is_some(_n: u64) -> Result<ExecutionCost, CostFunctionError> {
        Ok(ExecutionCost::runtime(31))
    }
    fn cost_unwrap(_n: u64) -> Result<ExecutionCost, CostFunctionError> {
        Ok(ExecutionCost::runtime(31))
    }
    fn cost_unwrap_err(_n: u64) -> Result<ExecutionCost, CostFunctionError> {
        Ok(ExecutionCost::runtime(31))
    }
    fn cost_try_ret(_n: u64) -> Result<ExecutionCost, CostFunctionError> {
        Ok(ExecutionCost::runtime(31))
    }
    // Bench: match/* → 31 units constant.
    fn cost_match(_n: u64) -> Result<ExecutionCost, CostFunctionError> {
        Ok(ExecutionCost::runtime(31))
    }
    ...
    fn cost_as_max_len(_n: u64) -> Result<ExecutionCost, CostFunctionError> {
        Ok(ExecutionCost::runtime(31))
    }
    ...
    fn cost_buff_to_int_le(_n: u64) -> Result<ExecutionCost, CostFunctionError> {
        Ok(ExecutionCost::runtime(31))
    }
    fn cost_buff_to_uint_le(_n: u64) -> Result<ExecutionCost, CostFunctionError> {
        Ok(ExecutionCost::runtime(31))
    }
    fn cost_buff_to_int_be(_n: u64) -> Result<ExecutionCost, CostFunctionError> {
        Ok(ExecutionCost::runtime(31))
    }
    fn cost_buff_to_uint_be(_n: u64) -> Result<ExecutionCost, CostFunctionError> {
        Ok(ExecutionCost::runtime(31))
    }
    // Bench: is-standard → 31 units constant.
    fn cost_is_standard(_n: u64) -> Result<ExecutionCost, CostFunctionError> {
        Ok(ExecutionCost::runtime(31))
    }
    // Bench: principal-destruct?, principal-construct? → 32 units constant.
    fn cost_principal_destruct(_n: u64) -> Result<ExecutionCost, CostFunctionError> {
        Ok(ExecutionCost::runtime(32))
    }
    fn cost_principal_construct(_n: u64) -> Result<ExecutionCost, CostFunctionError> {
        Ok(ExecutionCost::runtime(32))
    }
    ...
    fn cost_int_to_ascii(_n: u64) -> Result<ExecutionCost, CostFunctionError> {
        Ok(ExecutionCost::runtime(31))
    }
    fn cost_int_to_utf8(_n: u64) -> Result<ExecutionCost, CostFunctionError> {
        Ok(ExecutionCost::runtime(31))
    }
    ...
    fn cost_bitwise_not(_n: u64) -> Result<ExecutionCost, CostFunctionError> {
        Ok(ExecutionCost::runtime(31))
    }
    // Bench: bit-shift-left/right → 31 units constant.
    fn cost_bitwise_left_shift(_n: u64) -> Result<ExecutionCost, CostFunctionError> {
        Ok(ExecutionCost::runtime(31))
    }
    fn cost_bitwise_right_shift(_n: u64) -> Result<ExecutionCost, CostFunctionError> {
        Ok(ExecutionCost::runtime(31))
    }
    ...
    fn cost_secp256r1verify(_n: u64) -> Result<ExecutionCost, CostFunctionError> {
        Ok(ExecutionCost::runtime(38))
    }
    ...
    fn cost_secp256k1decompress(_n: u64) -> Result<ExecutionCost, CostFunctionError> {
