...
//         self.store.get_contract_analysis(contract_identifier)
//             .map_err(|e| 
//                 CheckErrors::Expects(
//                     format!("Failed to load contract analysis: {}", e.to_string())
//                 ).into()
//             )
//     }
...
//         epoch: &StacksEpochId,
//     ) -> CheckResult<Option<ContractAnalysis>> {
//         Ok(self.store.get_contract_analysis(contract_identifier)
//             .map_err(|e| 
//                 CheckErrors::Expects(
//                     format!("Failed to load contract analysis: {}", e.to_string())
//                 )
