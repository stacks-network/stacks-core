...
pub fn check_special_map(
    ...
    if let Err(mut check_error) = check_result {
        if let CheckErrorKind::IncorrectArgumentCount(expected, _actual) = *check_error.err {
            check_error.err = Box::new(CheckErrorKind::IncorrectArgumentCount(
                expected,
...
pub fn check_special_filter(
...

    {
        ...
        if TypeSignature::BoolType != filter_type {
            return Err(CheckErrorKind::TypeError(
...
pub fn check_special_fold(
    ...
    let input_type = match argument_type {
        ...
        _ => Err(CheckErrorKind::ExpectedSequence(Box::new(argument_type))),
    }?;
...
pub fn check_special_concat(
    ...
    let res = match (&lhs_type, &rhs_type) {
        ...
        _ => return Err(CheckErrorKind::ExpectedSequence(Box::new(lhs_type.clone())).into()),
    };
    Ok(res)
}
...
pub fn check_special_as_max_len(
    ...
    match sequence {
        ...
        _ => Err(CheckErrorKind::ExpectedSequence(Box::new(sequence)).into()),
    }
}
...
pub fn check_special_len(
    ...
    match collection_type {
        ...
        _ => Err(CheckErrorKind::ExpectedSequence(Box::new(collection_type))),
    }?;
...
pub fn check_special_element_at(
    ...
    match collection_type {
        ...
        _ => Err(CheckErrorKind::ExpectedSequence(Box::new(collection_type)).into()),
    }
}
...
pub fn check_special_index_of(
    ...
    let expected_input_type = match list_type {
        TypeSignature::SequenceType(ref sequence_type) => Ok(sequence_type.unit_type()?),
        _ => Err(CheckErrorKind::ExpectedSequence(Box::new(list_type))),
    }?;
...
pub fn check_special_slice(
    ...
    let seq = match seq_type {
        ...
        _ => return Err(CheckErrorKind::ExpectedSequence(Box::new(seq_type)).into()),
    };
...
pub fn check_special_replace_at(
    ...
    let seq_type = match &input_type {
        ...
        _ => return Err(CheckErrorKind::ExpectedSequence(Box::new(input_type)).into()),
    };
