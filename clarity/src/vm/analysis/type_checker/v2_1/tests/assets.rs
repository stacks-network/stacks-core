...
fn test_bad_asset_usage() {
    ...
    let expected = [
        ...
        CheckErrorKind::BadTokenName,
        CheckErrorKind::TypeError(TypeSignature::PrincipalType, TypeSignature::UIntType),
        CheckErrorKind::TypeError(TypeSignature::PrincipalType, TypeSignature::IntType),
        CheckErrorKind::BadTokenName,
        CheckErrorKind::NoSuchNFT("stackoos".to_string()),
        CheckErrorKind::TypeError(string_ascii_type(10), TypeSignature::UIntType),
        CheckErrorKind::TypeError(string_ascii_type(10), string_ascii_type(15)),
        CheckErrorKind::BadTokenName,
        CheckErrorKind::NoSuchNFT("stackoos".to_string()),
        CheckErrorKind::TypeError(string_ascii_type(10), TypeSignature::UIntType),
        CheckErrorKind::TypeError(string_ascii_type(10), string_ascii_type(15)),
        ...
        CheckErrorKind::BadTokenName,
        CheckErrorKind::TypeError(TypeSignature::PrincipalType, TypeSignature::UIntType),
        CheckErrorKind::TypeError(TypeSignature::UIntType, TypeSignature::BoolType),
        CheckErrorKind::BadTokenName,
        CheckErrorKind::NoSuchNFT("stackoos".to_string()),
        CheckErrorKind::TypeError(TypeSignature::PrincipalType, TypeSignature::UIntType),
        CheckErrorKind::TypeError(TypeSignature::PrincipalType, TypeSignature::UIntType),
