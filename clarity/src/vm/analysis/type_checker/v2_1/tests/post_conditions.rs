...
fn test_restrict_assets(#[case] version: ClarityVersion, #[case] epoch: StacksEpochId) {
    ...
    let bad = [
        ...
        (
            ...
            StaticAnalysisError::WithAllAllowanceNotAllowed,
        ),
        // no asset-owner
        (
            "(restrict-assets? ((with-stx u5000)) true)",
            StaticAnalysisError::RequiresAtLeastArguments(3, 2),
        ),
        // no asset-owner, 3 args
        (
            "(restrict-assets? ((with-stx u5000)) true true)",
            StaticAnalysisError::NonFunctionApplication,
        ),
        ...
        (
            ...
            StaticAnalysisError::ExpectedListApplication,
        ),
        // other value in place of allowance list
        (
            "(restrict-assets? tx-sender u1 true)",
            StaticAnalysisError::ExpectedListOfAllowances("restrict-assets?".into(), 2),
        ),
        ...
        (
            ...
            StaticAnalysisError::UnknownFunction("foo".into()),
        ),
        // no body expressions
        (
        ...
        (
            ...
            StaticAnalysisError::UncheckedIntermediaryResponses,
        ),
        ...
        (
            ...
            StaticAnalysisError::TooManyAllowances(MAX_ALLOWANCES, 130),
        ),
    ...
    for (code, expected_type) in &good {
        if version < ClarityVersion::Clarity4 {
            ...
            assert_eq!(
                StaticAnalysisError::UnknownFunction("restrict-assets?".to_string()),
...
fn test_as_contract(#[case] version: ClarityVersion, #[case] epoch: StacksEpochId) {
    ...
    let bad = [
        ...
        (
            "(as-contract? u1 true)",
            StaticAnalysisError::ExpectedListOfAllowances("as-contract?".into(), 1),
        ),
        // non-allowance in allowance list
        (
            "(as-contract? (u1) true)",
        ...
        (
            ...
            StaticAnalysisError::WithAllAllowanceNotAlone,
        ),
    ...
    for (code, expected_type) in &good {
        if version < ClarityVersion::Clarity4 {
            ...
            assert_eq!(
                StaticAnalysisError::UnknownFunction("as-contract?".to_string()),
                *type_check_helper_version(code, version, epoch)
                    .unwrap_err()
                    .err,
                "{code}"
...
fn test_with_ft_allowance(#[case] version: ClarityVersion, #[case] epoch: StacksEpochId) {
    ...
    let bad = [
        ...
        (
            ...
            StaticAnalysisError::IncorrectArgumentCount(3, 1),
        ),
        // two arguments
        (
...
fn test_with_nft_allowance(#[case] version: ClarityVersion, #[case] epoch: StacksEpochId) {
    ...
    let bad = [
        ...
        (
            ...
            StaticAnalysisError::MaxIdentifierLengthExceeded(MAX_NFT_IDENTIFIERS, 130),
        ),
    ];
...
fn test_with_all_assets_unsafe_allowance(
    ...
    let bad = [
        ...
        (
            ...
            StaticAnalysisError::IncorrectArgumentCount(0, 1),
        ),
    ];
