...
use crate::vm::errors::{
    check_argument_count, check_arguments_at_least, CheckErrors, RuntimeErrorType,
    VmExecutionResult,
};
...
pub fn list_cons(
    ...
    let eval_tried: VmExecutionResult<Vec<Value>> =
...
pub fn native_len(sequence: Value) -> VmExecutionResult<Value> {
    match sequence {
...
pub fn native_index_of(sequence: Value, to_find: Value) -> VmExecutionResult<Value> {
...
pub fn native_element_at(sequence: Value, index: Value) -> VmExecutionResult<Value> {
