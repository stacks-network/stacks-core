...
macro_rules! native_hash_func {
    ($name:ident, $module:ty) => {
        pub fn $name(input: Value) -> VmExecutionResult<Value> {
...
fn pubkey_to_address_v1(pub_key: Secp256k1PublicKey) -> VmExecutionResult<StacksAddress> {
...
fn pubkey_to_address_v2(
    ...
    is_mainnet: bool,
) -> VmExecutionResult<StacksAddress> {
