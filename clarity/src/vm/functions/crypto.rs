...
pub fn pubkey_to_address_v1(pub_key: Secp256k1PublicKey) -> StacksAddress {
...
pub fn pubkey_to_address_v2(pub_key: Secp256k1PublicKey, is_mainnet: bool) -> StacksAddress {
