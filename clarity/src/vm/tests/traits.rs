...
fn test_dynamic_dispatch_intra_contract_call(
...

    {
        ...
        let err_result = env
            ...
            .unwrap_err();
        match err_result {
            VmExecutionError::IntegrityCheck(CheckErrorKind::CircularReference(_)) => {}
            _ => panic!("{err_result:?}"),
        }
    }
}
...
fn test_dynamic_dispatch_mismatched_args(
...

    {
        ...
        let err_result = env
            ...
            .unwrap_err();
        match err_result {
            VmExecutionError::IntegrityCheck(CheckErrorKind::BadTraitImplementation(_, _)) => {}
            _ => panic!("{err_result:?}"),
        }
    }
}
...
fn test_dynamic_dispatch_mismatched_returned(
...

    {
        ...
        let err_result = env
            ...
            .unwrap_err();
        match err_result {
            VmExecutionError::IntegrityCheck(CheckErrorKind::ReturnTypesMustMatch(_, _)) => {}
            _ => panic!("{err_result:?}"),
        }
    }
}
...
fn test_readwrite_dynamic_dispatch(
...

    {
        ...
        let err_result = env
            ...
            .unwrap_err();
        match err_result {
            VmExecutionError::IntegrityCheck(CheckErrorKind::TraitBasedContractCallInReadOnly) => {}
            _ => panic!("{err_result:?}"),
        }
    }
}
