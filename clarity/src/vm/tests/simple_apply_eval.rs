...
use crate::vm::errors::{EarlyReturnError, RuntimeAnalysisError, RuntimeError, VmExecutionError};
...
fn test_doubly_defined_persisted_vars() {
    ...
    for p in tests.iter() {
        assert_eq!(
            ...
            RuntimeAnalysisError::NameAlreadyUsed("cursor".into()).into()
        );
    }
}
...
fn test_secp256k1_errors() {
    ...
    let expectations: &[VmExecutionError] = &[
        RuntimeAnalysisError::TypeValueError(Box::new(TypeSignature::BUFFER_32), Box::new(Value::Sequence(SequenceData::Buffer(BuffData { data: hex_bytes("de5b9eb9e7c5592930eb2e30a01369c36586d872082ed8181ee83d2a0ec20f").unwrap() })))).into(),
        RuntimeAnalysisError::TypeValueError(Box::new(TypeSignature::BUFFER_65), Box::new(Value::Sequence(SequenceData::Buffer(BuffData { data: hex_bytes("8738487ebe69b93d8e51583be8eee50bb4213fc49c767d329632730cc193b873554428fc936ca3569afc15f1c9365f6591d6251a89fee9c9ac661116824d3a130100").unwrap() })))).into(),
        RuntimeAnalysisError::IncorrectArgumentCount(2, 1).into(),
        RuntimeAnalysisError::IncorrectArgumentCount(2, 3).into(),

        RuntimeAnalysisError::TypeValueError(Box::new(TypeSignature::BUFFER_32), Box::new(Value::Sequence(SequenceData::Buffer(BuffData { data: hex_bytes("de5b9eb9e7c5592930eb2e30a01369c36586d872082ed8181ee83d2a0ec20f").unwrap() })))).into(),
        RuntimeAnalysisError::TypeValueError(Box::new(TypeSignature::BUFFER_65), Box::new(Value::Sequence(SequenceData::Buffer(BuffData { data: hex_bytes("8738487ebe69b93d8e51583be8eee50bb4213fc49c767d329632730cc193b873554428fc936ca3569afc15f1c9365f6591d6251a89fee9c9ac661116824d3a130111").unwrap() })))).into(),
        RuntimeAnalysisError::TypeValueError(Box::new(TypeSignature::BUFFER_33), Box::new(Value::Sequence(SequenceData::Buffer(BuffData { data: hex_bytes("03adb8de4bfb65db2cfd6120d55c6526ae9c52e675db7e47308636534ba7").unwrap() })))).into(),
        RuntimeAnalysisError::IncorrectArgumentCount(3, 2).into(),
...
fn test_simple_arithmetic_errors(#[case] version: ClarityVersion, #[case] epoch: StacksEpochId) {
    ...
    let expectations: &[VmExecutionError] = &[
        ...
        RuntimeError::Arithmetic("Power argument to (pow ...) must be a u32 integer".to_string())
            .into(),
        RuntimeAnalysisError::TypeError(
...
fn test_options_errors() {
    ...
    let expectations: &[VmExecutionError] = &[
        RuntimeAnalysisError::IncorrectArgumentCount(1, 2).into(),
        RuntimeAnalysisError::ExpectedOptionalValue(Box::new(Value::Bool(true))).into(),
        RuntimeAnalysisError::IncorrectArgumentCount(1, 2).into(),
        RuntimeAnalysisError::ExpectedResponseValue(Box::new(Value::Bool(true))).into(),
        RuntimeAnalysisError::IncorrectArgumentCount(1, 2).into(),
        RuntimeAnalysisError::ExpectedResponseValue(Box::new(Value::Bool(true))).into(),
        RuntimeAnalysisError::IncorrectArgumentCount(1, 2).into(),
        RuntimeAnalysisError::ExpectedOptionalValue(Box::new(Value::Bool(true))).into(),
        ...
        RuntimeAnalysisError::IncorrectArgumentCount(2, 3).into(),
        RuntimeAnalysisError::ExpectedOptionalValue(Box::new(Value::Bool(true))).into(),
        RuntimeAnalysisError::ExpectedTuple(Box::new(TypeSignature::IntType)).into(),
        RuntimeAnalysisError::ExpectedTuple(Box::new(TypeSignature::IntType)).into(),
    ];
...
fn test_stx_ops_errors() {
    ...
    let expectations: &[VmExecutionError] = &[
        RuntimeAnalysisError::IncorrectArgumentCount(3, 2).into(),
        RuntimeAnalysisError::BadTransferSTXArguments.into(),
        RuntimeAnalysisError::BadTransferSTXArguments.into(),
        RuntimeAnalysisError::BadTransferSTXArguments.into(),
        RuntimeAnalysisError::IncorrectArgumentCount(4, 3).into(),
        RuntimeAnalysisError::BadTransferSTXArguments.into(),
        RuntimeAnalysisError::BadTransferSTXArguments.into(),
        RuntimeAnalysisError::BadTransferSTXArguments.into(),
        RuntimeAnalysisError::IncorrectArgumentCount(2, 1).into(),
...
fn test_option_destructs() {
    ...
    let expectations: &[Result<Value, VmExecutionError>] = &[
        Ok(Value::Int(1)),
        Ok(Value::Int(1)),
        Err(RuntimeAnalysisError::ExpectedResponseValue(Box::new(
        ...
        Ok(Value::Int(2)),
        Ok(Value::Int(8)),
        Err(RuntimeAnalysisError::BadMatchInput(Box::new(TypeSignature::IntType)).into()),
        Err(RuntimeAnalysisError::BadMatchInput(Box::new(TypeSignature::IntType)).into()),
        ...
        Ok(Value::Bool(true)),
        Err(RuntimeAnalysisError::IncorrectArgumentCount(1, 2).into()),
        Err(RuntimeAnalysisError::ExpectedOptionalOrResponseValue(Box::new(Value::Int(1))).into()),
    ];
...
fn test_bad_lets() {
    ...
    let expectations: &[VmExecutionError] = &[
        RuntimeAnalysisError::NameAlreadyUsed("tx-sender".to_string()).into(),
        RuntimeAnalysisError::NameAlreadyUsed("*".to_string()).into(),
        RuntimeAnalysisError::NameAlreadyUsed("a".to_string()).into(),
        RuntimeAnalysisError::NoSuchDataVariable("cursor".to_string()).into(),
        RuntimeAnalysisError::NameAlreadyUsed("true".to_string()).into(),
        RuntimeAnalysisError::NameAlreadyUsed("false".to_string()).into(),
    ];
