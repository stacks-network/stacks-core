...
fn test_bitwise() {
    ...
    let tests = [
        ...
        "(^ 1 2 4 -1)",         // -8
        "(>> u123 u9999999999)", // u0
        "(<< u123 u9999999999)", // u170141183460469231731687303715884105728
        ...
        "(>> 5 u2)",            // 1
        "(>> -5 u2)",           // -2
        "(<< 123 u9999999999)", // -170141183460469231731687303715884105728
        "(>> 123 u9999999999)", // 0
    ];
    ...
    let expectations: &[Result<Value, Error>] = &[
        ...
        Ok(Value::UInt(0)),     // (>> u123 u9999999999)
        Ok(Value::UInt(170141183460469231731687303715884105728)),     // (<< u123 u9999999999)
        ...
        Ok(Value::Int(1)),      // (>> 5 u2)
        Ok(Value::Int(-2)),     // (>> -5 u2)
        Ok(Value::Int(-170141183460469231731687303715884105728)),      // (<< 123 u9999999999)
        Ok(Value::Int(0)),      // (>> 123 u9999999999)
    ];
