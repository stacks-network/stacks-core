...
impl RPCPoxInfoData {
    pub fn from_db(
        ...
        let cur_cycle_pox_contract = sortdb
            .pox_constants
            .active_pox_contract(burnchain.reward_cycle_to_block_height(reward_cycle_id));
        let next_cycle_pox_contract = sortdb
            .pox_constants
