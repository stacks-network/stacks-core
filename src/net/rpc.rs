...
impl ConversationHttp {
    ...
    fn handle_getmicroblocks_confirmed<W: Write>(
        ...
        monitoring::increment_rpc_request_counter(
            "/v2/microblocks/confirmed".to_string(),
            "get".to_string(),
        ); //promserver
        let response_metadata = HttpResponseMetadata::from(req);
    ...
    fn handle_readonly_function_call<W: Write>(
        ...
        monitoring::increment_rpc_request_counter(
            "/v2/contracts/call-read".to_string(),
            "post".to_string(),
        ); //promserver
        let response_metadata = HttpResponseMetadata::from(req);
        let contract_identifier =
    ...
    fn handle_get_contract_abi<W: Write>(
        ...
        monitoring::increment_rpc_request_counter(
            "/v2/contracts/interface".to_string(),
            "get".to_string(),
        ); //promserver
        let response_metadata = HttpResponseMetadata::from(req);
        let contract_identifier =
    ...
    fn handle_getmicroblocks_unconfirmed<W: Write>(
        ...
        monitoring::increment_rpc_request_counter(
            "/v2/microblocks/unconfirmed".to_string(),
            "get".to_string(),
        ); //promserver
        let response_metadata = HttpResponseMetadata::from(req);
    ...
    fn handle_gettransaction_unconfirmed<W: Write>(
        ...
        monitoring::increment_rpc_request_counter(
            "/v2/transactions/unconfirmed".to_string(),
            "get".to_string(),
        ); //promserver
        let response_metadata = HttpResponseMetadata::from(req);
