...
mod test {
    ...
    fn test_verify_withdrawal_merkle_tree() {
        ...
        assert_eq!(
            ...
            vec![
                153, 10, 43, 242, 160, 228, 145, 217, 85, 36, 235, 59, 148, 118, 109, 81, 120, 23, 174, 225,
                 19, 149, 220, 102, 116, 49, 228, 44, 66, 78, 232, 74
            ]
        );
        ...
        assert_eq!(
            ...
            vec![
                162, 136, 132, 170, 231, 227, 33, 135, 19, 92, 199, 182, 216, 230, 39, 31, 30,
                191, 124, 1, 38, 84, 237, 67, 218, 68, 255, 186, 146, 179, 26, 214
            ]
        );
        ...
        assert_eq!(
            ...
            vec![
                3, 71, 251, 33, 201, 246, 155, 190, 62, 133, 213, 253, 91, 188, 69, 162, 137,
                13, 175, 192, 20, 117, 147, 103, 70, 7, 196, 149, 56, 193, 5, 107
            ]
        );
