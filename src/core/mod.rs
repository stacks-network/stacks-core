...
/// This is Epoch-2.3, now Epoch-2.4, activation height proposed in SIP-022
pub const BITCOIN_MAINNET_STACKS_24_BURN_HEIGHT: u64 = 789_751;
...
lazy_static! {
    pub static ref STACKS_EPOCHS_MAINNET: [StacksEpoch; 7] = [
        StacksEpoch {
