...
pub const BITCOIN_MAINNET_STACKS_22_BURN_HEIGHT: u64 = 3_000_000;
...
pub const BITCOIN_TESTNET_STACKS_22_BURN_HEIGHT: u64 = 5_000_000;
...
fn test_ord_for_stacks_epoch() {
    ...
    assert_eq!(epochs[0].cmp(&epochs[3]), Ordering::Less);
    assert_eq!(epochs[1].cmp(&epochs[3]), Ordering::Less);
    assert_eq!(epochs[2].cmp(&epochs[3]), Ordering::Less);
...
fn test_ord_for_stacks_epoch_id() {
    ...
    assert_eq!(
        StacksEpochId::Epoch10.cmp(&StacksEpochId::Epoch22),
        Ordering::Less
    );
    assert_eq!(
        StacksEpochId::Epoch20.cmp(&StacksEpochId::Epoch22),
        Ordering::Less
    );
    assert_eq!(
        StacksEpochId::Epoch2_05.cmp(&StacksEpochId::Epoch22),
        Ordering::Less
    );
    assert_eq!(
    ...
    assert_eq!(
        StacksEpochId::Epoch22.cmp(&StacksEpochId::Epoch22),
        Ordering::Equal
    );
    assert_eq!(
    ...
    assert_eq!(
        StacksEpochId::Epoch22.cmp(&StacksEpochId::Epoch20),
        Ordering::Greater
    );
    assert_eq!(
        StacksEpochId::Epoch22.cmp(&StacksEpochId::Epoch10),
        Ordering::Greater
    );
    assert_eq!(
        StacksEpochId::Epoch22.cmp(&StacksEpochId::Epoch2_05),
        Ordering::Greater
    );
}
