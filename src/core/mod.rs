...
pub const BITCOIN_MAINNET_FIRST_BLOCK_HEIGHT: u64 = 665520;
pub const BITCOIN_MAINNET_FIRST_BLOCK_TIMESTAMP: u32 = 1610337493;
pub const BITCOIN_MAINNET_FIRST_BLOCK_HASH: &str =
    "00000000000000000003a2239f3e13a0dc4f1d6dbd710ec210a384d7fac78a84";
