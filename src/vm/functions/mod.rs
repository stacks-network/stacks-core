...
pub fn lookup_reserved_functions(name: &str) -> Option<CallableType> {
    ...
    if let Some(native_function) = NativeFunctions::lookup_by_name(name) {
        let callable = match native_function {
            Add => CallableType::NativeFunction("native_add", &arithmetic::native_add, cost_functions::ADD),
            Subtract => CallableType::NativeFunction("native_sub", &arithmetic::native_sub, cost_functions::SUB),
            Multiply => CallableType::NativeFunction("native_mul", &arithmetic::native_mul, cost_functions::MUL),
            Divide => CallableType::NativeFunction("native_div", &arithmetic::native_div, cost_functions::DIV),
            CmpGeq => CallableType::NativeFunction("native_geq", &arithmetic::native_geq, cost_functions::GEQ),
            CmpLeq => CallableType::NativeFunction("native_leq", &arithmetic::native_leq, cost_functions::LEQ),
            CmpLess => CallableType::NativeFunction("native_le", &arithmetic::native_le, cost_functions::LE),
            CmpGreater => CallableType::NativeFunction("native_ge", &arithmetic::native_ge, cost_functions::GE),
            ToUInt => CallableType::NativeFunction("native_to_uint", &arithmetic::native_to_uint, cost_functions::INT_CAST),
            ToInt => CallableType::NativeFunction("native_to_int", &arithmetic::native_to_int, cost_functions::INT_CAST),
            Modulo => CallableType::NativeFunction("native_mod", &arithmetic::native_mod, cost_functions::MOD),
            Power => CallableType::NativeFunction("native_pow", &arithmetic::native_pow, cost_functions::POW),
            BitwiseXOR => CallableType::NativeFunction("native_xor", &arithmetic::native_xor, cost_functions::XOR),
            ...
            Not => CallableType::NativeFunction("native_not", &boolean::native_not, cost_functions::NOT),
            Equals => CallableType::NativeFunction("native_eq", &native_eq, cost_functions::EQ),
            ...
            AsMaxLen => CallableType::SpecialFunction("native_as_max_len", &iterables::native_as_max_len),
            ...
            ListCons => CallableType::SpecialFunction("special_list_cons", &iterables::list_cons),
            ...
            Begin => CallableType::NativeFunction("native_begin", &native_begin, cost_functions::BEGIN),
            Hash160 => CallableType::NativeFunction("native_hash160", &native_hash160, cost_functions::HASH160),
            Sha256 => CallableType::NativeFunction("native_sha256", &native_sha256, cost_functions::SHA256),
            Sha512 => CallableType::NativeFunction("native_sha512", &native_sha512, cost_functions::SHA512),
            Sha512Trunc256 => CallableType::NativeFunction("native_sha512trunc256", &native_sha512trunc256, cost_functions::SHA512T256),
            Keccak256 => CallableType::NativeFunction("native_keccak256", &native_keccak256, cost_functions::KECCAK256),
            Print => CallableType::NativeFunction("native_print", &native_print, cost_functions::PRINT),
            ...
            ConsSome => CallableType::NativeFunction("native_some", &options::native_some, cost_functions::SOME_CONS),
            ConsOkay => CallableType::NativeFunction("native_okay", &options::native_okay, cost_functions::OK_CONS),
            ConsError => CallableType::NativeFunction("native_error", &options::native_error, cost_functions::ERR_CONS),
            DefaultTo => CallableType::NativeFunction("native_default_to", &options::native_default_to, cost_functions::DEFAULT_TO),
            Asserts => CallableType::SpecialFunction("native_asserts", &special_asserts),
            UnwrapRet => CallableType::NativeFunction("native_unwrap_ret", &options::native_unwrap_or_ret, cost_functions::UNWRAP_RET),
            UnwrapErrRet => CallableType::NativeFunction("native_unwrap_err_ret", &options::native_unwrap_err_or_ret, cost_functions::UNWRAP_ERR_OR_RET),
            IsOkay => CallableType::NativeFunction("native_is_okay", &options::native_is_okay, cost_functions::IS_OKAY),
            IsNone => CallableType::NativeFunction("native_is_none", &options::native_is_none, cost_functions::IS_NONE),
            IsErr => CallableType::NativeFunction("native_is_err", &options::native_is_err, cost_functions::IS_ERR),
            IsSome => CallableType::NativeFunction("native_is_some", &options::native_is_some, cost_functions::IS_SOME),
            Unwrap => CallableType::NativeFunction("native_unwrap", &options::native_unwrap, cost_functions::UNWRAP),
            UnwrapErr => CallableType::NativeFunction("native_unwrap_err", &options::native_unwrap_err, cost_functions::UNWRAP_ERR),
            Match => CallableType::SpecialFunction("special_match", &options::special_match),
            TryRet => CallableType::NativeFunction("native_try_ret", &options::native_try_ret, cost_functions::TRY_RET),
