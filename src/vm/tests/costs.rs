...
pub fn get_simple_test(function: &NativeFunctions) -> &'static str {
    ...
    match function {
        ...
        AsMaxLen => "(as-max-len? list-bar 3u)",
        Len => "(len list-bar)",
        ...
        GetBlockInfo => "(get-block-info? time 1u)",
        ConsOkay => "(ok 1)",
        ConsError => "(err 1)",
        ConsSome => "(some 1)",
        ...
        MintAsset => "(ft-mint? ft-foo 1u 'SZ2J6ZY48GV1EZ5V2V5RB9MP66SW86PYKKQ9H6DPR)",
        ...
        TransferToken => "(ft-transfer? ft-foo 1u 'SZ2J6ZY48GV1EZ5V2V5RB9MP66SW86PYKKQ9H6DPR 'SZ2J6ZY48GV1EZ5V2V5RB9MP66SW86PYKKQ9H6DPR)",
        ...
        StxTransfer => "(stx-transfer? 1u 'SZ2J6ZY48GV1EZ5V2V5RB9MP66SW86PYKKQ9H6DPR 'SZ2J6ZY48GV1EZ5V2V5RB9MP66SW86PYKKQ9H6DPR)",
        StxBurn => "(stx-burn? 1u 'SZ2J6ZY48GV1EZ5V2V5RB9MP66SW86PYKKQ9H6DPR)",
    }
}
