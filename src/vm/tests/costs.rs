...
pub fn get_simple_test(function: &NativeFunctions) -> &'static str {
    ...
    match function {
        ...
        PrincipalParse => "(principal-parse version 'STB44HYPYAT2BB2QE513NSP81HTMYWBJP02HPGK6)",
        PrincipalConstruct => "(principal-construct 0x26 0x164247d6f2b425ac5771423ae6c80c754f7172b0)",
