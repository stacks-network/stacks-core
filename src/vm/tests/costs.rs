...
pub fn get_simple_test(function: &NativeFunctions) -> &'static str {
    ...
    match function {
        ...
        FetchEntry => "(map-get? map-foo (tuple (a 1)))",
        FetchContractEntry => "(contract-map-get? .contract-other map-foo (tuple (a 1)))",
        SetEntry => "(map-set map-foo (tuple (a 1)) (tuple (b 2)))",
        InsertEntry => "(map-insert map-foo (tuple (a 2)) (tuple (b 2)))",
        DeleteEntry => "(map-delete map-foo (tuple (a 1)))",
        TupleCons => "(tuple (a 1))",
