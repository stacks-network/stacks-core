...
pub fn get_simple_test(function: &NativeFunctions) -> &'static str {
    ...
    match function {
        ...
        BuffToIntLe => "(buff-to-int-le 0x00000000000000000000000000000000)",
        BuffToUIntLe => "(buff-to-uint-le 0x00000000000000000000000000000000)",
        BuffToIntBe => "(buff-to-int-be 0x00000000000000000000000000000000)",
        BuffToUIntBe => "(buff-to-uint-be 0x00000000000000000000000000000000)",
