...
fn test_stx_ops() {
    let good = [
        ...
        r#"(stx-transfer? u10 tx-sender 'SM2J6ZY48GV1EZ5V2V5RB9MP66SW86PYKKQVX8X0G "")"#,
        r#"(stx-transfer? u10 tx-sender 'SM2J6ZY48GV1EZ5V2V5RB9MP66SW86PYKKQVX8X0G "memo message")"#,
    ...
    let bad_expected = [
        CheckErrors::TypeError(
            PrincipalType,
            SequenceType(StringType(ASCII(BufferLength(0)))),
        ),
        CheckErrors::TypeError(UIntType, IntType),
        ...
        CheckErrors::TypeError(SequenceType(StringType(ASCII(BufferLength(34)))), BoolType),
