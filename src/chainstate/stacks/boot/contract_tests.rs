...
fn test_vote_for_exit_rc() {
    ...
    sim.execute_next_block(|env| {
        ...
        // Vote for reward cycle below the absolute minimum allowable reward cycle
...
// TODO - question, should I add a function to see inside map state? maybe read clarity state?
