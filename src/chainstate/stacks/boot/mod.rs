...
impl StacksChainState {
    ...
    pub fn load_cost_functions(
        ...
        let mut state_summary = self.load_state_summary(clarity_db)?;
        ...
        self.store_state_summary(clarity_db, &state_summary)?;
