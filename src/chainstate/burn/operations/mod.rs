...
impl BlockstackOperationType {
    pub fn opcode(&self) -> Opcodes {
        match *self {
            ...
            BlockstackOperationType::PegHandoff(_) => Opcodes::PegHandoff,
    ...
    pub fn txid_ref(&self) -> &Txid {
        match *self {
            ...
            BlockstackOperationType::PegHandoff(ref data) => &data.txid,
    ...
    pub fn vtxindex(&self) -> u32 {
        match *self {
            ...
            BlockstackOperationType::PegHandoff(ref data) => data.vtxindex,
    ...
    pub fn block_height(&self) -> u64 {
        match *self {
            ...
            BlockstackOperationType::PegHandoff(ref data) => data.block_height,
    ...
    pub fn burn_header_hash(&self) -> BurnchainHeaderHash {
        match *self {
            ...
            BlockstackOperationType::PegHandoff(ref data) => data.burn_header_hash.clone(),
    ...
    pub fn set_block_height(&mut self, height: u64) {
        match self {
            ...
            BlockstackOperationType::PegHandoff(ref mut data) => data.block_height = height,
    ...
    pub fn set_burn_header_hash(&mut self, hash: BurnchainHeaderHash) {
        match self {
            ...
            BlockstackOperationType::PegHandoff(ref mut data) => data.burn_header_hash = hash,
    ...
    pub fn blockstack_op_to_json(&self) -> serde_json::Value {
        match self {
            ...
            BlockstackOperationType::PegHandoff(op) => json!({ "peg_handoff": op }),
...
impl fmt::Display for BlockstackOperationType {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match *self {
            ...
            BlockstackOperationType::PegHandoff(ref op) => write!(f, "{:?}", op),
