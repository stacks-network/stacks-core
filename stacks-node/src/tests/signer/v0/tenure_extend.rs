...
fn tenure_extend_after_idle_signers_with_buffer() {
    ...
    let timestamps: HashSet<_> = signer_test
        .running_nodes
        .test_observer
...
fn prev_miner_extends_if_incoming_miner_fails_to_mine_success() {
    ...
    let miner_1_block_n_1 = wait_for_block_pushed_by_miner_key(
        30,
        stacks_height_before + 1,
        &miner_pk_1,
        &miners.signer_test.running_nodes.test_observer,
...
fn non_blocking_minority_configured_to_favour_incoming_miner() {
    ...
    let miner_1_block_n_2 = wait_for_block_pushed_by_miner_key(
        30,
        stacks_height_before + 1,
        &miner_pk_1,
        &miners.signer_test.running_nodes.test_observer,
...
fn non_blocking_minority_configured_to_favour_prev_miner_v1() {
    ...
    let miner_2_block_n_2 = wait_for_block_pushed_by_miner_key(
        30,
        stacks_height_before + 1,
        &miner_pk_2,
        &miners.signer_test.running_nodes.test_observer,
...
fn continue_after_fast_block_no_sortition() {
    ...
    let block_n_3 = wait_for_block_pushed_by_miner_key(
        30,
