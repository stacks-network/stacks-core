...
fn atlas_integration_test() {
    ...
    let mut btcd_controller = BitcoinCoreController::from_stx_config(conf_bootstrap_node.clone());
    btcd_controller
        .start_bitcoind()
        .expect("Failed starting bitcoind");
...
fn bitcoin_reorg_flap() {
    ...
    let mut btcd_controller = BitcoinCoreController::from_stx_config(new_conf.clone());
