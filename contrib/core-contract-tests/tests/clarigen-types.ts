...
export const contracts = {
  ...
  pox5: {
    functions: {
      ...
      addStakerToBond: {
        ...
        >
      >,
      addStakerToBondCycles: {
        name: 'add-staker-to-bond-cycles',
        access: 'private',
        args: [
          { name: 'staker', type: 'principal' },
          { name: 'signer', type: 'principal' },
        ...
        >
      >,
      addStakerToBondForCycle: {
        name: 'add-staker-to-bond-for-cycle',
        access: 'private',
        args: [
          { name: 'cycle-index', type: 'uint128' },
          {
      ...
      >,
      removeStakerFromBondCycles: {
        name: 'remove-staker-from-bond-cycles',
        access: 'private',
        args: [
          { name: 'staker', type: 'principal' },
          { name: 'signer', type: 'principal' },
        ...
        >
      >,
      removeStakerFromBondForCycle: {
        name: 'remove-staker-from-bond-for-cycle',
        access: 'private',
        args: [
          { name: 'cycle-index', type: 'uint128' },
          {
      ...
      announceL1EarlyExit: {
        ...
        [
          staker: TypedAbiArg<string, 'staker'>,
          oldSignerManager: TypedAbiArg<string, 'oldSignerManager'>,
        ],
        Response<
          {
            amountSatsReleased: bigint;
            bondIndex: bigint;
            signer: string;
            staker: string;
          },
      ...
      computeEarnedRewards: {
        ...
        args: [
          ...
          { name: 'rpt-current', type: 'uint128' },
          { name: 'rpt-paid', type: 'uint128' },
          { name: 'pending', type: 'uint128' },
        ],
        outputs: { type: 'uint128' },
      } as TypedAbiFunction<
        [
          shares: TypedAbiArg<number | bigint, 'shares'>,
          rptCurrent: TypedAbiArg<number | bigint, 'rptCurrent'>,
          rptPaid: TypedAbiArg<number | bigint, 'rptPaid'>,
          pending: TypedAbiArg<number | bigint, 'pending'>,
        ],
        bigint
      >,
      ...
      getSignerSharesStakedForCycle: {
        ...
        bigint
      >,
      getSignerUnclaimedRewardsForCycle: {
      ...
      >,
      getStakerRewardsPerTokenSettledForCycle: {
      ...
      getStakerSharesStakedForCycle: {
        ...
        bigint
      >,
      getStakerUnclaimedRewardsForCycle: {
    ...
    maps: {
      ...
      signerRewardsPerTokenForCycle: {
        ...
        bigint
      >,
      signerRewardsPerTokenSettledForCycle: {
      ...
      signerSharesStakedForCycle: {
        ...
        bigint
      >,
      signerUnclaimedRewardsForCycle: {
      ...
      >,
      stakerRewardsPerTokenSettledForCycle: {
      ...
      >,
      stakerUnclaimedRewardsForCycle: {
  ...
  pox5AuthProxy: {
    functions: {
      registerForBondForSender: {
        name: 'register-for-bond-for-sender',
        access: 'public',
        args: [
          { name: 'bond-index', type: 'uint128' },
          { name: 'signer-manager', type: 'trait_reference' },
      ...
      stakeForSender: {
        ...
        >
      >,
      stakeUpdateForSender: {
        name: 'stake-update-for-sender',
        access: 'public',
        args: [
          { name: 'signer-manager', type: 'trait_reference' },
          { name: 'old-signer-manager', type: 'trait_reference' },
  ...
  signerManagerV2: {
    functions: {
      ...
      >,
      storePayoutConfig: {
        name: 'store-payout-config',
        access: 'private',
        args: [
          { name: 'staker', type: 'principal' },
          { name: 'calldata', type: { buffer: { length: 500 } } },
        ],
        outputs: { type: { response: { ok: 'bool', error: 'uint128' } } },
      } as TypedAbiFunction<
        [
      ...
      setPayoutConfig: {
        ...
        [
          ...
          >,
          maxFee: TypedAbiArg<number | bigint, 'maxFee'>,
          minClaim: TypedAbiArg<number | bigint, 'minClaim'>,
        ],
        Response<boolean, bigint>
      >,
      settleAcceptedWithdrawal: {
      ...
      getPendingFees: {
        ...
        outputs: {
          type: {
            tuple: [
              { name: 'activation-cycle', type: 'uint128' },
              { name: 'active-bips', type: 'uint128' },
              { name: 'pending-bips', type: 'uint128' },
            ],
          },
        },
      } as TypedAbiFunction<
    ...
    maps: {
      ...
      unclaimedRewardsForCycle: {
        name: 'unclaimed-rewards-for-cycle',
        key: {
          tuple: [
            { name: 'bond-index', type: { optional: 'uint128' } },
            { name: 'reward-cycle', type: 'uint128' },
    ...
    variables: {
      ...
      FEE_ACTIVATION_DELAY_CYCLES: {
        name: 'FEE_ACTIVATION_DELAY_CYCLES',
        type: 'uint128',
        access: 'constant',
      } as TypedAbiVariable<bigint>,
      MAX_FEE_BIPS: {
      ...
      pendingFeesBips: {
        name: 'pending-fees-bips',
        type: 'uint128',
        access: 'variable',
      } as TypedAbiVariable<bigint>,
      pendingFeesCycle: {
        name: 'pending-fees-cycle',
        type: 'uint128',
        access: 'variable',
      } as TypedAbiVariable<bigint>,
    ...
    epoch: 'Epoch40',
    clarity_version: 'Clarity6',
    contractName: 'signer-manager-v2',
  },
  signers: {
    functions: {
      setSigners: {
...
export const identifiers = {
  ...
  pox5AuthProxy: 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.pox-5-auth-proxy',
  ...
  signerManagerV2:
    'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.signer-manager-v2',
...
export const deployments = {
  ...
  pox5AuthProxy: {
    devnet: 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.pox-5-auth-proxy',
    simnet: 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.pox-5-auth-proxy',
    testnet: null,
    mainnet: null,
  },
  pox_4_test: {
  ...
  signerManager: {
    ...
    simnet: 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.signer-manager',
    testnet: null,
    mainnet: null,
  },
  signerManagerV2: {
    devnet: 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.signer-manager-v2',
    simnet: 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.signer-manager-v2',
    testnet: null,
    mainnet: null,
  },
  signers: {
