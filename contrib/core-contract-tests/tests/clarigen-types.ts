...
export const contracts = {
  ...
  pox5: {
    functions: {
      ...
      >,
      innerStakeUpdate: {
        name: 'inner-stake-update',
        access: 'private',
        args: [
          { name: 'amount-ustx-increase', type: 'uint128' },
          {
            name: 'pool-or-solo-info',
            type: {
              response: {
        ...
        [
          amountUstxIncrease: TypedAbiArg<
            number | bigint,
            'amountUstxIncrease'
          >,
          poolOrSoloInfo: TypedAbiArg<
      ...
      updateAmountUstxStaked: {
        ...
        Response<boolean, bigint>
      >,
      updateAmountUstxStakedForCycle: {
        name: 'update-amount-ustx-staked-for-cycle',
        access: 'private',
        args: [
          { name: 'cycle-index', type: 'uint128' },
          {
    ...
    maps: {
      ...
      >,
      rewardCycleTotalStaked: {
        name: 'reward-cycle-total-staked',
        key: 'uint128',
        value: 'uint128',
...
export const identifiers = {
  ...
  pox5Indirect: 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.pox-5-indirect',
...
export const deployments = {
  ...
  pox5Indirect: {
    devnet: 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.pox-5-indirect',
    simnet: 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.pox-5-indirect',
    testnet: null,
    mainnet: null,
  },
  pox_4_test: {
