...
def scenario( wallets, **kw ):
    ...
    # try to exceed quota all at once
    ...
    # should fail
    resp = testlib.blockstack_name_register('foo26.test', wallets[2].privkey, wallets[3].addr)
    testlib.next_block( **kw )
...
def check( state_engine ):
    ...
    # all foo's should succeed but the last
    for i in xrange(0, 25):
    ...
    # foo26.test should not be registered 
