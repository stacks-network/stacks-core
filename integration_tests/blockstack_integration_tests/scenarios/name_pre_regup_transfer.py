...
def scenario( wallets, **kw ):
    ...
    testlib.blockstack_name_transfer( 'foo1.test', wallets[4].addr, True, wallets[3].privkey )
    ...
    testlib.blockstack_name_transfer( 'foo1.test', wallets[0].addr, False, wallets[4].privkey )
    testlib.blockstack_name_transfer( 'foo2.test', wallets[0].addr, False, wallets[4].privkey )
    testlib.blockstack_name_transfer( 'foo3.test', wallets[0].addr, False, wallets[4].privkey )
