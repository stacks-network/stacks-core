...
wallets = [
    testlib.Wallet( "5JesPiN68qt44Hc2nT8qmyZ1JDwHebfoh9KQ52Lazb1m1LaKNj9", 100000000000, vesting={STACKS: {694: VESTING_AMOUNT + 1}}),
    testlib.Wallet( "5KHqsiU9qa77frZb6hQy9ocV7Sus9RWJcQGYYBJJBb2Efj1o77e", 100000000000, vesting={STACKS: {694: VESTING_AMOUNT * 2}}),
    testlib.Wallet( "5Kg5kJbQHvk1B64rJniEmgbD83FpZpbw2RjdAZEzTefs9ihN3Bz", 100000000000, vesting={STACKS: {694: VESTING_AMOUNT * 3}}),
    testlib.Wallet( "5JuVsoS9NauksSkqEjbUZxWwgGDQbMwPsEfoRBSpLpgDX1RtLX7", 100000000000, vesting={STACKS: {694: VESTING_AMOUNT * 4}}),
    testlib.Wallet( "5KEpiSRr1BrT8vRD7LKGCEmudokTh1iMHbiThMQpLdwBwhDJB1T", 100000000000, vesting={STACKS: {694: VESTING_AMOUNT * 5}}),
]
...
def scenario( wallets, **kw ):
    ...
    expected_balances = {
        wallets[0].addr: {STACKS: initial_balances[wallets[0].addr][STACKS] - namespace_cost + VESTING_AMOUNT + 1},
        wallets[1].addr: {STACKS: initial_balances[wallets[1].addr][STACKS] + VESTING_AMOUNT  * 2},
        wallets[2].addr: {STACKS: initial_balances[wallets[2].addr][STACKS] - name_cost + VESTING_AMOUNT * 3},
        wallets[3].addr: {STACKS: initial_balances[wallets[3].addr][STACKS] + VESTING_AMOUNT  * 4},
        wallets[4].addr: {STACKS: initial_balances[wallets[4].addr][STACKS] + VESTING_AMOUNT  * 5}
    }
