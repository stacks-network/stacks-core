...
def scenario( wallets, **kw ):
    ...
    testlib.blockstack_name_register( "foo1.test", wallets[2].privkey, wallets[3].addr)
    testlib.blockstack_name_register( "foo2.test", wallets[2].privkey, wallets[3].addr)
    testlib.blockstack_name_register( "foo3.test", wallets[2].privkey, wallets[3].addr)
    testlib.next_block( **kw )

    testlib.blockstack_name_update( 'foo1.test', '11' * 20, wallets[3].privkey)
    testlib.blockstack_name_update( 'foo2.test', '22' * 20, wallets[3].privkey)
    testlib.blockstack_name_update( 'foo3.test', '33' * 20, wallets[3].privkey)
    testlib.next_block( **kw )
    ...
    testlib.blockstack_name_preorder( "foo1.test", wallets[3].privkey, wallets[2].addr )
    testlib.blockstack_name_preorder( "foo2.test", wallets[3].privkey, wallets[2].addr )
