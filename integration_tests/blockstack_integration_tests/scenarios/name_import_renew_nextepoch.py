...
"""
TEST ENV BLOCKSTACK_EPOCH_1_END_BLOCK 265
"""
...
def check( state_engine ):
    ...
    current_fee = original_price * blockstack.lib.config.EPOCHS[1]['PRICE_MULTIPLIER']
    ...
    epoch_cost_multiplier = blockstack.get_epoch_price_multiplier( 266 )
