...
def scenario( wallets, **kw ):
    ...
    resp = testlib.blockstack_name_preorder_multi( ["foo.test", "bar.test", "baz.test", "goo.test"], wallets[2].privkey, [wallets[3].addr, wallets[4].addr, wallets[5].addr, wallets[6].addr] )
    if 'error' in resp:
