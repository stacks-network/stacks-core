...
def scenario( wallets, **kw ):
    ...
    # wait for a bit...
    for i in xrange(0, 6 * blockstack.NAMESPACE_LIFETIME_MULTIPLIER - 1):
        testlib.next_block( **kw )
...
def check( state_engine ):
    ...
    if name_rec['last_renewed'] - (6 * blockstack.NAMESPACE_LIFETIME_MULTIPLIER + 1) != name_rec['first_registered']:
