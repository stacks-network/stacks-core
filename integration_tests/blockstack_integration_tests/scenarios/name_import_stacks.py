...
def scenario( wallets, **kw ):
    ...
    # should be accepted
    testlib.blockstack_name_preorder( "foo.test", wallets[2].privkey, wallets[4].addr, safety_checks=False )
    testlib.next_block( **kw )

    # should be rejected
    testlib.blockstack_name_register( "foo.test", wallets[2].privkey, wallets[4].addr, safety_checks=False )
    testlib.next_block( **kw )
