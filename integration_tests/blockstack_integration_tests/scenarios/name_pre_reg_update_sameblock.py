...
def scenario( wallets, **kw ):
    ...
    # should be rejected
    testlib.blockstack_name_update('foo.test', '11' * 20, wallets[3].privkey, safety_checks=False, tx_fee=30000)
...
def check( state_engine ):
    ...
    # no update 
    if name_rec.has_key('value_hash') and name_rec['value_hash'] is not None:
        print 'got updated'
        return False
