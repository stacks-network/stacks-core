...
def check( state_engine ):
    ...
    fees = {
        ...
        'b': blockstack.price_namespace('b', 694),
        'bs': blockstack.price_namespace('bs', 694),
        'bsdf': blockstack.price_namespace('bsdf', 694),
        'bsdfasdf': blockstack.price_namespace('bsdfasdf', 694),
