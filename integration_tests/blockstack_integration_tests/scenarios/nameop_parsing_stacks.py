...
def check( state_engine ):
    ...
    name_preorders = {
        ...
        "valid_stacks_short":  "%s%s%s%s" % ("11" * 20, "22" * 16, '00' * 8, binascii.hexlify('a') + '00' * 18),
        "valid_stacks_full":  "%s%s%s%s" % ("11" * 20, "22" * 16, '00' * 8, binascii.hexlify('abcdefghijklmnopqrs')),
    ...
    name_registrations = {
        ...
        "valid_stacks": binascii.hexlify("hello.test" + '\00' * 27 + '\x11' * 20 + '\x00' * 8),
