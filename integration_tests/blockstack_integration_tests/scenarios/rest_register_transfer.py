...
def scenario( wallets, **kw ):
    ...
    res = testlib.blockstack_cli_app_publish("foo.test", "names,register,prices,user_read,user_write,user_admin,zonefiles,transfer", index_file_path, appname="register", drivers="disk", password="0123456789abcdef" )
    if 'error' in res:
