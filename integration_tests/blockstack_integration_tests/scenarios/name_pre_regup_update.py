...
def scenario( wallets, **kw ):
    ...
    testlib.blockstack_name_update( "foo1.test", '1a' * 20, wallets[3].privkey)
    testlib.blockstack_name_update( "foo2.test", '2a' * 20, wallets[3].privkey)
    testlib.blockstack_name_update( "foo3.test", '3a' * 20, wallets[3].privkey)
    testlib.next_block( **kw )
