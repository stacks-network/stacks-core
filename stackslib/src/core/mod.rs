...
pub static STACKS_EPOCHS_MAINNET: LazyLock<[StacksEpoch; 9]> = LazyLock::new(|| {
    [
        StacksEpoch {
...
pub static STACKS_EPOCHS_TESTNET: LazyLock<[StacksEpoch; 9]> = LazyLock::new(|| {
    [
        StacksEpoch {
            epoch_id: StacksEpochId::Epoch10,
            start_height: 0,
...
pub static STACKS_EPOCHS_REGTEST: LazyLock<[StacksEpoch; 9]> = LazyLock::new(|| {
    [
        StacksEpoch {
            epoch_id: StacksEpochId::Epoch10,
            start_height: 0,
