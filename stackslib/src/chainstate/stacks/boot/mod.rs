...
pub static BOOT_CODE_POX_MAINNET: LazyLock<String> = LazyLock::new(|| format!("{BOOT_CODE_POX_MAINNET_CONSTS}\n{BOOT_CODE_POX_BODY}"));
pub static BOOT_CODE_POX_TESTNET: LazyLock<String> = LazyLock::new(|| format!("{BOOT_CODE_POX_TESTNET_CONSTS}\n{BOOT_CODE_POX_BODY}"));
pub static POX_2_MAINNET_CODE: LazyLock<String> = LazyLock::new(|| format!("{BOOT_CODE_POX_MAINNET_CONSTS}\n{POX_2_BODY}"));
pub static POX_2_TESTNET_CODE: LazyLock<String> = LazyLock::new(|| format!("{BOOT_CODE_POX_TESTNET_CONSTS}\n{POX_2_BODY}"));
pub static POX_3_MAINNET_CODE: LazyLock<String> = LazyLock::new(|| format!("{BOOT_CODE_POX_MAINNET_CONSTS}\n{POX_3_BODY}"));
pub static POX_3_TESTNET_CODE: LazyLock<String> = LazyLock::new(|| format!("{BOOT_CODE_POX_TESTNET_CONSTS}\n{POX_3_BODY}"));
pub static POX_4_CODE: LazyLock<String> = LazyLock::new(|| POX_4_BODY.to_string());
pub static BOOT_CODE_COST_VOTING_TESTNET: LazyLock<String> = LazyLock::new(|| make_testnet_cost_voting());
pub static STACKS_BOOT_CODE_MAINNET: LazyLock<[(&'static str, &'static str); 6]> = LazyLock::new(|| [
...
pub static STACKS_BOOT_CODE_TESTNET: LazyLock<[(&'static str, &'static str); 6]> = LazyLock::new(|| [
