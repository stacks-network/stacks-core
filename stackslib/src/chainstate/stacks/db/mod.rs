...
impl<'a, 'b> ClarityTx<'a, 'b> {
    ...
    /// Returns the replaced block limit if there is one.
    pub fn set_block_limit(&mut self, block_limit: ExecutionCost) -> Option<ExecutionCost> {
        self.block.set_block_limit(block_limit)
    }
