...
mod test {
    ...
    fn tx_stacks_spending_condition_p2wpkh() {
        ...
        let spending_conditions = [spending_condition_p2wpkh_compressed];
        let spending_conditions_bytes = [spending_condition_p2wpkh_compressed_bytes];
    ...
    fn tx_stacks_spending_condition_p2wsh() {
        ...
        let spending_conditions = [spending_condition_p2wsh];
        let spending_conditions_bytes = [spending_condition_p2wsh_bytes];
