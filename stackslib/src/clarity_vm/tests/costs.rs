...
static COST_VOTING_MAINNET_CONTRACT: LazyLock<QualifiedContractIdentifier> = LazyLock::new(|| boot_code_id("cost-voting", true));
static COST_VOTING_TESTNET_CONTRACT: LazyLock<QualifiedContractIdentifier> = LazyLock::new(|| boot_code_id("cost-voting", false));
