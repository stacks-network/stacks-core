...
static CLARITY_NAME_NO_BOUNDARIES_REGEX_STRING: LazyLock<String> = LazyLock::new(|| format!(
        "([a-zA-Z]([a-zA-Z0-9]|[-_!?+<>=/*])*|[-+=/*]|[<>]=?){{1,{}}}",
        MAX_STRING_LEN
    ));
static METADATA_KEY_REGEX_STRING: LazyLock<String> = LazyLock::new(|| format!(
