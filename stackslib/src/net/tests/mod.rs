...
pub(super) fn setup_rlimit_nofiles() {
    ...
    info!("Raising nofile rlimit from {soft_limit} to {requested_soft_limit} for network tests");
    rlimit::setrlimit(rlimit::Resource::NOFILE, requested_soft_limit, hard_limit)
