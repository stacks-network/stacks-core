...
- `"microblocks"`: Subscribes to new microblock stream events.
  ...
  - **Payload details**:
    ...
    - The "events" field will contain STX, FT, NFT, or specific smart contract events _only if_ this observer is also subscribed to those more specific event types (e.g., via `"stx"`, `"*"`, a specific contract event key, or a specific asset identifier key).
...
{
  "dropped_txids": [
    "d7b667bb93898b1d3eba4fee86617b06b95772b192f3643256dd0821b476e36f"
  ],
  "reason": "ReplaceByFee"
}
```
