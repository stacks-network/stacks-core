...
fn fix_to_pox_contract() {
    ...
    let sort_height = channel.get_sortitions_processed();
    info!("pre bootstrap 2.1, sort_height: {}, epoch_2_4: {}", sort_height, epoch_2_4);
    ...
    let sort_height = channel.get_sortitions_processed();
    info!("sort_height: {}, epoch_2_1: {}", sort_height, epoch_2_1);
    ...
    let sort_height = channel.get_sortitions_processed();
    info!("pre bootstrap, sort_height: {}, epoch_2_4: {}", sort_height, epoch_2_4);
    ...
    let sort_height = channel.get_sortitions_processed();
    info!("sort_height: {}, epoch_2_4: {}", sort_height, epoch_2_4);
