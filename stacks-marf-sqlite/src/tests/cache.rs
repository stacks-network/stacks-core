...
use crate::{MARFValue, MARFOpenOpts, TrieFileStorage, MARF, MarfTrieId, TrieLeaf};
...
fn test_marf_with_cache(
    ...
    let write_bench = marf.get_benchmarks();
    marf.get_benchmarks().reset();
    ...
    let read_bench = marf.get_benchmarks();
    eprintln!(
