...
pub use clarity_kernel::signatures::{
    FixedFunction, FunctionArg, FunctionArgSignature, FunctionReturnsSignature, FunctionSignature,
    FunctionType,
};
...
impl TypeSignatureExt for TypeSignature {
    ...
    fn parse_trait_type_repr<A: CostTracker>(
        ...
        if functions_types.len() > MAX_TRAIT_METHODS {
        ...
        for function_type in functions_types.iter() {
            ...
            if fn_args_exprs.len() > MAX_FUNCTION_PARAMETERS {
