...
def make_transaction(name, recipient_address, update_hash, user_public_key, blockchain_client, tx_fee=0):
    ...
    outputs = make_outputs(nulldata, inputs, recipient_address, from_address, update_hash_b58, tx_fee)
