...
def get_testset_filename( working_dir=None ):
   ...
   testset_filepath = os.path.join( working_dir, blockstack_impl.get_virtual_chain_name() ) + ".testset"
...
def get_announce_filename( working_dir=None ):
   ...
   announce_filepath = os.path.join( working_dir, blockstack_impl.get_virtual_chain_name() ) + ".announce"
...
def default_blockstack_opts( config_file=None, testset=False ):
   ...
   if config_file is None:
      config_file = virtualchain.get_config_filename(impl=blockstack_impl)

   testset_path = get_testset_filename( virtualchain.get_working_dir(impl=blockstack_impl) )
   announce_path = get_announce_filename( virtualchain.get_working_dir(impl=blockstack_impl) )
