...
def namedb_patch_v2_upgrade_signal(con):
    """
    Simple db "migration", add the v2 upgrade metadata table
    """
    sql = 'CREATE TABLE IF NOT EXISTS v2_upgrade_signal(id INT PRIMARY KEY, threshold_block_id INT, import_block_id INT)'
    namedb_query_execute(con, sql, ())
    sql_default_vals = 'INSERT OR IGNORE INTO v2_upgrade_signal VALUES (1, null, null)'
    namedb_query_execute(con, sql_default_vals, ())
