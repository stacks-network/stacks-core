...
def hash_zonefile( zonefile_data ):
    """
    Calculate the hash of a zonefile
    """
    zonefile_txt = serialize_zonefile( zonefile_data )
    zonefile_hash = blockstack_client.get_name_zonefile_hash( zonefile_txt )
