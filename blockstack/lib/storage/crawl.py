...
def get_zonefile_data_from_storage( name, zonefile_hash, drivers=None ):
    ...
    zonefile_txt = blockstack_client.storage.get_immutable_data( zonefile_hash, hash_func=blockstack_client.get_blockchain_compat_hash, blockchain_id=name, zonefile=True, drivers=drivers )
