...
use crate::chainstate::{ProposalEvalConfig, SignerChainstateError, SortitionState};
...
impl LocalStateMachine {
    ...
    pub fn check_miner_inactivity(
        ...
        if !SortitionState::is_timed_out(tenure_id, db, proposal_config.block_proposal_timeout)? {
            return Ok(());
        }
    ...
    pub fn make_miner_state(
        ...
        let signerdb_last_block = SortitionState::get_tenure_last_block_info(
