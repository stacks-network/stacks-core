...
def scenario( wallets, **kw ):
    ...
    # re-preorder...
    resp = testlib.blockstore_name_preorder( "foo.test", wallets[4].privkey, wallets[0].addr )
    if 'error' in resp:
        print json.dumps( resp, indent=4 )
    ...
    # re-register 
    resp = testlib.blockstore_name_register( "foo.test", wallets[4].privkey, wallets[0].addr )
    if 'error' in resp:
        print json.dumps( resp, indent=4 )
